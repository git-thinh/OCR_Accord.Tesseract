...
namespace IPoVnSystem
{
    ...
    public sealed class Parallel
    {
        ...
        public delegate void ForLoopBodyByPassParameters(int index, object parameters);
        ...
        public static void For(int start, int stop, ForLoopBodyByPassParameters loopBody)
        {
            lock (sync)
            {
                // get instance of parallel computation manager
        ...
        private void Initialize()
        {
            ...
            for (int i = 0; i < threadsCount; i++)
            {
                ...
                threads[i].Name = "SiGlaz.Parallel";
